...
4.  Compute the split keys and then split the table.
    ...
    1.  Pass that CSV file into the &nbsp;[`SYSCS_UTIL.SYSCS_SPLIT_TABLE_OR_INDEX`](sqlref_sysprocs_splittable.html) procedure.

    2.  This computes the split row keys and split your table inside the database.
    {: .LowerAlphaPlainFont}
