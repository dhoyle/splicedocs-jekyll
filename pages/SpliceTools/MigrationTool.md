...
The configuration file that controls how your database migration operates, contains two main sections, each of which is described here:

* The [Connections](#connections) section describes the different database connections you can use for exporting data from other databases and importing data into Splice Machine.
* The [Configs](#configs) sections contains configurations, each of which contains a set of configuration options settings.
