...
6.  Change How SQL Comments are Specified
    {: .topLevel}
    ...
    1. Select *Session Properties* from the SQuirreL *Session* menu.

    2. Click the *SQL* tab in the Session Properties window.

    3. Change the *Start of Line Comment* setting from `--` to `//`:
