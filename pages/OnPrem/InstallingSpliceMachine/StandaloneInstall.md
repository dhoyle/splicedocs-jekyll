...
1.  Download the Splice Machine installer.
    ...
    Visit this page:
    [`{{splvar_location_StandaloneLink}}`]({{splvar_location_StandaloneLink}}){:
    target="_blank"}.
    {: .indentLevel1}
    ...
    <table>
                                ...
                                <tbody>
                                   <tr>
                                       ...
                                       <td><a href="{{splvar_install_v26_Standalone}}">{{splvar_install_v26_Standalone}}</a></td>
                                    </tr>
                                    <tr>
                                   ...
                                   <tr>
                                       ...
                                       <td><a href="{{splvar_install_v25_Standalone}}">{{splvar_install_v25_Standalone}}</a></td>
                                    </tr>
                                </tbody>
                            </table>
