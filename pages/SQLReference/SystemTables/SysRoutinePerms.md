...
If you see the table description, you have access; if, instead, you see a message that the table doesn't exist, you don't have access to the table; use the [`SYSVW.SYSROUTINEPERMSVIEW` system view](sqlref_sysviews_sysroutinepermsview.html) instead.
