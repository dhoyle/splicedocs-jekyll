...
You can use the optional `SPLITKEYS` clause to generate optimal region splits when indexing large table, as described in the [Using Split Keys](#splitkeys) section below, and elaborated upon in our [Creating Indexes for Large Tables](#tutorials_indexing_largeindex.html) tutorials.
{: .paramDefnFirst}
...
You can define logical *or* physical split keys for the index whether or not you're using Bulk HFile loading to create the index. Our [Creating Indexes for Large Tables](tutorials_indexing_largeindex.html) tutorial page provides detailed information about using automatic sampling or providing your own region split keys.
{: .noteIcon}
...
* [Creating Indexes for Large Tables](#tutorials_indexing_largeindex.html)
* [Importing Data: Bulk HFile Import](tutorials_ingest_importbulkhfile.html)
* [Import Parameters Tutorial](tutorials_ingest_importparams.html)
* 
</div>
</section>
