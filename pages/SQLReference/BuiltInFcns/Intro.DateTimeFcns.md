---
title: Built-in Date and Time SQL functions in Splice Machine
summary: Summary of built-in SQL functions in Splice Machine for working with date and time values
keywords: date and time functions
toc: false
product: all
sidebar:  sqlref_sidebar
permalink: sqlref_builtinfcns_datetimefcnsintro.html
...
<table summary="Summary of Splice Machine SQL Date and Time Functions">
                <col />
                <col />
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>This <a href="sqlref_builtinfcns_conversionfcnsintro.html">conversion function</a> formats a date value into a string.</td>
                </tr>
                <tr>
                    <td class="CodeFont"><a href="sqlref_builtinfcns_date.html">TO_DATE</a>
                    </td>
                    <td>This <a href="sqlref_builtinfcns_conversionfcnsintro.html">conversion function</a> formats a date string according to a formatting specification, and returns a date value.</td>
                </tr>
                <tr>
                    <td class="CodeFont"><a href="sqlref_builtinfcns_truncate.html">TRUNC <span class="bodyFont">or</span> TRUNCATE</a>
                    </td>
                    <td>This <a href="sqlref_builtinfcns_numericfcnsintro.html">numeric function</a> truncates numeric, date, and timestamp values.</td>
                </tr>
                <tr>
