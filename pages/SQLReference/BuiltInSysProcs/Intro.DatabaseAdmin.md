...
{% if site.incl_notyet %}
                <tr>
                    <td class="CodeFont"><a href="VacuumSchema.html">SYSCS_UTIL.VACUUM_SCHEMA</a>
                    </td>
                    <td>Improves the performance of your database by cleaning no longer needed historical update data from a schema.</td>
                </tr>
                <tr>
                    <td class="CodeFont"><a href="VacuumTable.html">SYSCS_UTIL.VACUUM_TABLE</a>
                    </td>
                    <td>Improves the performance of your database by cleaning no longer needed historical update data from a table.</td>
                </tr>
{% endif %}
                </tbody>
            </table>
