...
The following table summarizes the parameters used by `SYSCS_UTIL.SYSCS_SPLIT_TABLE_OR_INDEX` and other Splice Machine data importation procedures. Each parameter name links to a more detailed description in our [Importing Data Tutorial](tutorials_ingest_importparams.html).
